...
class WorklistServer:
    ...
    def __init__(self, serverConfig, app_logger, seed, blocking):
        self._config = serverConfig
        self._logger = app_logger
        self._blocking = blocking
        self._seed = seed
        self._worklist_factory = worklist.RandomWorklist('ISO_IR 100', self._seed)
        self._handlers = [
    ...
    def start(self):
        ...
        self._logger.info('Running worklist server with AE title {}, ip: {}, listening to port: {}, seed {}'.format(
